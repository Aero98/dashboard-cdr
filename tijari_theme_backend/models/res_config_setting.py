...
class ResConfig(models.TransientModel):
    ...
    tijari_favicon = fields.Binary(related='company_id.favicon',
    ...
    tijari_toobar_color = fields.Char('Toolbar Color', related='company_id.tijari_toobar_color', readonly=False)
