...
class Company(models.Model):
    ...
    tab_name = fields.Char(string="Backend Tab Name", default="CDR", readonly=False)
    ...
    app_name_pwa = fields.Char('App Name', readonly=False, default='tijari')
    short_name_pwa = fields.Char('Short Name', readonly=False, default='tijari')
    description_pwa = fields.Char('App Description', readonly=False, default='tijari')
    ...
    tijari_toobar_color = fields.Char('Toolbar Color', readonly=False, default='#0097a7')
