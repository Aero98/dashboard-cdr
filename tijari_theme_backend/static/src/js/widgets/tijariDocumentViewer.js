odoo.define('tijari_theme_backend.tijariDocumentViewer', function (require) {
  "use strict";
  ...
  var tijariDocumentViewer = Widget.extend({
      template: "tijariDocumentViewer",
      events: {
      ...
      _updateContent: function () {
          this.$('.o_viewer_content').html(QWeb.render('tijariDocumentViewer.Content', {
              widget: this
          }));
          this.$('.o_viewer_img').on("load", _.bind(this._onImageLoaded, this));
          this.$('[data-toggle="tooltip"]').tooltip({delay: 0});
