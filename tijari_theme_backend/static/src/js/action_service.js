...
function makeActionManager(env) {
    ...
    // tijari MULTI TAB START
    function updatetijariTabDetails(tabId, ActionId, controller) {
    ...
    async function _updateUI(controller, options = {}) {
        ...
        controller.config.setDisplayName = (displayName) => {
            ...
            if (controller.action.id){
                ...
                /* if($(menu_xmlid).length){
                    updatetijariTabDetails(tabID, UpdateAction, controller);
                } */
        ...
        // tijari MULTI TAB START
        sessionStorage.setItem("tijari_current_action", action._originalAction);
        sessionStorage.setItem("tijari_current_action_id", action.id);
        // tijari MULTI TAB END
