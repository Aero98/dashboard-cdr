...
var tijariDocumentViewer = require("tijari_theme_backend.tijariDocumentViewer");
...
import { useService } from "@web/core/utils/hooks";
    ...
    patch(ListRenderer.prototype, "tijari_theme_backend.ListRenderer", {
      setup() {
          this._super();
          var self = this
      ...
      _loadattachmentviewer: function (ev) {
        ...
        if (mimetype_match) {
          ...
          var tijari_attachmentViewer = new tijariDocumentViewer(self,biz_attachment_list,biz_attachment_id);
          tijari_attachmentViewer.appendTo($(".o_DialogManager"));
