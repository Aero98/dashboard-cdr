odoo.define('tijari_theme_backend.MenuJs', function (require) {
    'use strict';
     ...
     var qweb = core.qweb;
     var ColorPallet = require('tijari_theme_backend.ColorPalletJS')
     ...
     patch(NavBar.prototype, "theme_backend.MenuJs", {
         async setup(parent, menuData) {
            ...
            for (const menu of this.menuService.getApps()) {
             ...
             // tijari MULTI TAB START - on reload add multi tabs
                ...
                $.each(menu_data, function( key, value ) {
                    ...
                    if (current_record.use_icon) {
                        if (current_record.icon_class_name) {
                            ...
                            var icon_image = "<img class='img img-fluid' src='/tijari_theme_backend/static/description/bizople-icon.png' />"
                            }
         ...
         addmultitabtags: function (ev) {
            ...
            ajax.jsonRpc('/get/mutli/tab','call', {
                ...
                if (rec){
                    ...
                    var tijaristoredActionId = sessionStorage.getItem("tijari_current_action_id");
                    var tijaristoredAction = sessionStorage.getItem("tijari_current_action");

                    if (tijaristoredActionId){
                        var TabDiv = $('.multi_tab_section .multi_tab_div');
                        var ActiveMenu = TabDiv.find('a[data-action-id="'+ tijaristoredActionId +'"]');
         ...
         addconfiguratorclass: function (){
             ajax.rpc('/get/model/record').then(function(rec) {
                 ...
                 if(rec.record_dict[0].font_size){
                    loadCSS(`/tijari_theme_backend/static/src/scss/font_sizes/${rec.record_dict[0].font_size}.css`);
                 }
         ...
         _searchPages: function(){
            ...
            if ($selected_search_mainmenu_name != '0'){
             ...
             this.$search_modal_results.html(
                 core.qweb.render("tijari_theme_backend.MenuSearchResults", {
                     results: results,
                     widget: this,
                 })
             );
